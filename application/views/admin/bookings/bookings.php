                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <?php if($booking['serviceStatus'] != '2' && !$booking['serviceStatus']) { ?>
                                                            <a href="<?php echo base_url('#home'.$booking['id']); ?>" class="btn btn-link btn-primary dropdown-item">Add</a>
                                                        <?php } ?>
                                                        <?php if($booking['serviceStatus'] != '2' && !$booking['serviceStatus']) { ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if($booking['serviceStatus'] != '2' && !$booking['serviceStatus']) { ?>
                                                            <a href="<?php echo base_url('/images/index.php/'.$booking['id']); ?>" class="btn btn-link btn-primary dropdown-item">Download Invoice</a>
                                                        <?php } ?>
